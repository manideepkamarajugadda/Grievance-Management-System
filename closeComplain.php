  ...
  <tr>
    <td class="contentArea"><div class="errorMessage" align="center"></div>
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input name="btnLogin" type="submit" id="btnLogin" value=" Close Complain "  style="color:#FF0000;font-weight:bold;padding:10px;font-size:14px;"></td>
          </tr>
      </table></td>
  </tr>
</table>
