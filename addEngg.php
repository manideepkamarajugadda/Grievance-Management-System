...
<h3>Add New Attorney Details - Admin View</h3>
<form action="process.php?action=addEngg" method="post"  name="frmListUser" id="frmListUser">
  <table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#336699" class="entryTable">
    <tr id="entryTableHeader">
      <td>:: Add Attorney Details ::</td>
    </tr>
    <tr>
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <tr class="entryTable">
              <td class="label">&nbsp;Attorney Name</td>
              <td class="content"><input name="EngineerName" type="text" class="box" id="EngineerName" size="30" maxlength="20" /></td>
            </tr>
            <tr class="entryTable">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name="btnLogin" type="submit" id="btnLogin" onclick="MM_validateForm('EngineerName','','R','Email','','RisEmail','Mobile','','R','Address','','R','Password','','R');return document.MM_returnValue" value=" Register Now "></td>
            </tr>
        </table></td>
    </tr>
  </table>
