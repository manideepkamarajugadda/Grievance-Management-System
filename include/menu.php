...
<div id="ddblueblockmenu">
	  <div class="menutitle">Clients Menu</div>
		  <ul>
...
?>
<div id="ddblueblockmenu">
	  <div class="menutitle">Attorneys Menu</div>
		  <ul>
			<li><a href="<?php echo WEB_ROOT; ?>">Welcome &nbsp;<? echo ucwords($_SESSION['user_name']); ?></a></li>
...
<div id="ddblueblockmenu">
	  <div class="menutitle">Admin Menu</div>
		  <ul>
			...
			<li><a href="<?php echo WEB_ROOT; ?>view.php?mod=admin&view=enggDetails">Attorney Details</a></li>
			<li><a href="<?php echo WEB_ROOT; ?>view.php?mod=admin&view=custDetails">Client Details</a></li>
