  ...
  <tr>
    <td class="contentArea"><div class="errorMessage" align="center"></div>
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
          ...
          <tr class="entryTable">
            <td class="label">&nbsp;Pref Attorney </td>
            <td class="content"><font color="#FF0000"><b><?php echo $AttorneyName; ?></b></font></td>
          </tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input name="btnLogin" type="submit" id="btnLogin" value=" Assign Complain "></td>
          </tr>
      </table></td>
  </tr>
</table>
